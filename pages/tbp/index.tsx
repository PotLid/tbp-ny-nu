                    ...
                    <ul className="icons">
                        <li className="icons-list icons-list-first">
                            <a
                                ...
                                href="https://engineering.buffalo.edu/" rel="noreferrer noopener"
                                target="_blank">
                        ...
                        <li className="icons-list">
                            <a
                                className="icons-anchor"
                                href="https://www.facebook.com/ubseas/" rel="noreferrer noopener"
                                target="_blank">
                        ...
                        <li className="icons-list">
                            <a
                                className="icons-anchor"
                                href="https://twitter.com/UBengineering" rel="noreferrer noopener"
                                target="_blank">
                        ...
                        <li className="icons-list">
                            <a
                                className="icons-anchor"
                                href="https://www.linkedin.com/company/ub-seas" rel="noreferrer noopener"
                                target="_blank">
